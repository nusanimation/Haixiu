 ...
 */
        ...
        private void writeFeatures(){
            fileWriter f = new fileWriter(null,"feature.txt");
        ...
        private void pollDangDistance() {
            ...
            {
                wDist += Math.Sqrt(Math.Pow((this.wprev.x - this.sdata.Joints[JointID.WristLeft].Position.X), 2) + Math.Pow((this.wprev.y - this.sdata.Joints[JointID.WristLeft].Position.Y), 2) + Math.Pow((this.wprev.z - this.sdata.Joints[JointID.WristLeft].Position.Z), 2));
                this.wprev.x = this.sdata.Joints[JointID.WristLeft].Position.X;
                this.wprev.y = this.sdata.Joints[JointID.WristLeft].Position.Y;
                this.wprev.z = this.sdata.Joints[JointID.WristLeft].Position.Z;
